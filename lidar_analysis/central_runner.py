...
def build_config(experiment_config: dict, force: bool, cart_id: str, data_dir: Path) -> AnalysisConfig:
    return AnalysisConfig(
        ...
        split_source=str(experiment_config.get("split_source", "distance")),
        ...
        markers_required=bool(experiment_config.get("markers_required", False)),
        write_marker_pointcloud=bool(experiment_config.get("write_marker_pointcloud", False)),
        ...
        pcl_backend=experiment_config.get("pcl_backend", {"enabled": False, "executable": None, "work_dir": None, "keep_intermediate": True, "fail_if_missing": True}),
